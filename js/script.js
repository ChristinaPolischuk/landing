...
(function () {
  ...
  $(document).on('click', '.js-show-popup', function (e) {
    e.preventDefault();
    $('body').addClass('fixed');
    var titleText = $(this).closest('.services__block').find('.content-title').text();
    var descrText = $(this).closest('.services__block').find('.services__descr').text();
    var hiddenText = $(this).closest('.services__block').find('.services__block-popup').html();
  ...
  function formValidate(form) {
    var error = 0;
    var fieldRequired = form.find('.required');
  ...
  var servicesSlider = $('.services').on('init', function (slick) {
